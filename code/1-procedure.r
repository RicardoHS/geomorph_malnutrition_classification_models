...
res = test_svmRadial(df, c(x_procrustes_coord_names, y_procrustes_coord_names), data_filter = data_filter, test_name=t_name)
...
res = test_svmRadial(df, c(x_allom_coord_names, y_allom_coord_names), data_filter = data_filter, test_name=t_name)
results = results %>% rbind(res)
...
res = test_svmRadial(df, non_colinear_cols, data_filter = data_filter, test_name=t_name)
results = results %>% rbind(res)
...
res = test_svmRadial(df, colnames(distances_raw), data_filter = data_filter, test_name=t_name)
results = results %>% rbind(res)
